...
const statements = [
  `CREATE TABLE IF NOT EXISTS companies (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), name TEXT NOT NULL, logo_url TEXT, phone TEXT,
    email TEXT, address TEXT, city TEXT, website TEXT, gst_number TEXT,
    logo_data TEXT, brand_color TEXT DEFAULT '#f59e0b',
    currency TEXT DEFAULT 'PKR', created_at TEXT DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS users (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, name TEXT NOT NULL, email TEXT UNIQUE NOT NULL,
    phone TEXT, password_hash TEXT NOT NULL, role TEXT NOT NULL DEFAULT 'salesperson',
    is_active INTEGER DEFAULT 1, created_at TEXT DEFAULT CURRENT_TIMESTAMP,
    updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS product_categories (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, name TEXT NOT NULL,
    display_order INTEGER DEFAULT 0, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS products (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, category_id TEXT, name TEXT NOT NULL,
    ...
    is_active INTEGER DEFAULT 1, specs TEXT DEFAULT '{}',
    created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS pricing_rules (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, rule_key TEXT NOT NULL,
    rule_value TEXT NOT NULL, description TEXT,
    created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS price_history (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), product_id TEXT, old_price REAL, new_price REAL NOT NULL,
    changed_by TEXT, reason TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,
  ...
  `CREATE TABLE IF NOT EXISTS quotation_templates (
    ...
    validity_days INTEGER DEFAULT 15, is_default INTEGER DEFAULT 0,
    created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS leads (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, assigned_to TEXT,
    ...
    battery_required INTEGER DEFAULT 0, battery_preference TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS lead_activities (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), lead_id TEXT, user_id TEXT,
    activity_type TEXT NOT NULL, description TEXT, metadata TEXT DEFAULT '{}',
    created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS quotations (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), company_id TEXT, lead_id TEXT, template_id TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS quotation_items (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), quotation_id TEXT, product_id TEXT,
  ...
  `CREATE TABLE IF NOT EXISTS followups (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), lead_id TEXT, quotation_id TEXT,
    followup_type TEXT NOT NULL, channel TEXT DEFAULT 'whatsapp',
    message TEXT NOT NULL, scheduled_at TEXT NOT NULL, sent_at TEXT,
    status TEXT DEFAULT 'pending', response TEXT, response_at TEXT,
    created_by TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP)`,

  `CREATE TABLE IF NOT EXISTS whatsapp_sessions (
    id TEXT PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))), phone_number TEXT UNIQUE NOT NULL,
    lead_id TEXT, company_id TEXT, conversation_state TEXT DEFAULT 'idle',
    context TEXT DEFAULT '{}', last_message_at TEXT,
    created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP)`,
...
const alterStatements = [
  ...
  `ALTER TABLE companies ADD COLUMN brand_color TEXT DEFAULT '#f59e0b'`,
];
  ...
  try {
    ...
    for (const alt of alterStatements) {
      try {
        ...
        // column already exists on an older schema — safe to ignore
      }
    }
    saveDatabase();
